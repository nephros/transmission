git submodule add --branch post-0.25-transmission https://github.com/transmission/dht dht
git submodule add --branch post-2.0.20170509-transmission https://github.com/transmission/miniupnpc  miniupnpc
